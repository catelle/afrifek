...
// console.log(resources)
  return (
    <div className={cn("group relative w-full h-96", className)}>
      <div className="perspective-distant transform-3d h-full">
        ...
        {/* Main 3D container */}
        <div className="relative w-full h-full transform-3d group-hover:rotate-x-8 group-hover:rotate-y-12 group-hover:translate-z-16 transition-all duration-700 ease-out">
          ...
          {/* Main map container */}
          <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden shadow-2xl shadow-primary/20">
            {/* Shimmer effect */}
            <div className={cn(
